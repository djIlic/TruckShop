...
<main class="container">
    ...
    <div class="row">
        ...
        if(isset($_GET['strana'])) {
            ...
            $upit="SELECT * FROM model as m INNER JOIN slika as s ON m.modelId=s.modelId WHERE m.markaId=2 limit $strana, 8";
    ...
    <div class="row m-0 p-0">
        <div class="col-md-1">
            <ul class="pagination pagination-lg">
                <?php
                $upit = "SELECT COUNT(*) AS brPrikaza FROM model as m INNER JOIN slika as s ON m.modelId=s.modelId WHERE m.markaId=2";
